...
| 2026-09-11 (partial day, run 17:50 ET; a custom EL guardrail killed 268 conversations 12:57–16:10, cleaned up by another session) | 0 structural, 0 transcript | n/a — the day's real errors were all in the always-read buckets | 30 | 0 | fixed `(bug\|bother)(ing)?` missing "bugging" (it missed the day's ONE agent offer); new flag `callback_in_past` (a callback scheduled BEFORE it was written — 3 today, one lead got 3 calls in 4 minutes and asked for the DNC list); classifier follow-up for two more false ai_receptionist ("I can tell this is an AI call", "give it out to a AI agent") |
