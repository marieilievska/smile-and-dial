...
| `dnc`                                           | the **person themself** asked to stop, unprompted                            | agent _offered_ removal → "sure" got marked dnc                                                                                                           |
...
- Live agents via `ELEVENLABS_API_KEY` (the Smile & Dial workspace — separate from the old multi-department one as of 2026-08-18). One active webinar agent: **HireAI Webinar Invite** `agent_8801m0b5tv5reb0bj0r1kd4k9hnd`.
