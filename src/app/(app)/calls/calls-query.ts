...
export const CALLS_SELECT =
  "id, direction, status, outcome, goal_met, started_at, answered_at, ended_at, duration_seconds, talk_time_seconds, recording_path, score, cost_breakdown, extracted_data, summary, created_at, lead:leads(id, company, business_phone, owner_id), campaign:campaigns(id, name), agent:agents(id, name)";
