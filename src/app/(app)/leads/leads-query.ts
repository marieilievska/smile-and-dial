...
export const LEADS_SELECT =
  "id, company, business_phone, business_email, status, last_outcome, city, state, conversations, call_attempts, last_call_at, next_call_at, owner_id, list_id, list:lists(name)";
