  ...
  return (
    ...
    >
      ...
      <StatLink
        ...
        // Destination = the goal-met calls behind this count (same ET week,
        // same created_at window). The count is distinct businesses, so a lead
        // booked twice shows two rows there but counts once here.
