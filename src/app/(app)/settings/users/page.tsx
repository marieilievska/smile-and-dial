  ...
  return (
    <div className="flex flex-col gap-6 p-8">
      ...
      <section
        ...
        className="border-border bg-card animate-in fade-in slide-in-from-bottom-1 fill-mode-both grid grid-cols-2 gap-x-4 gap-y-3 rounded-xl border px-5 py-4 delay-75 duration-500 sm:grid-cols-3"
      >
        <StatTile
