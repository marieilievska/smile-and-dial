...
const DATA_COLLECTION_FIELDS = [
  ...
  },
  {
    ...
    description:
      ...
      "time or timeframe was given (e.g. call_back_later). If you DO fill this " +
      "field, the disposition MUST be callback (unless the goal was met) — never " +
      "gatekeeper or call_back_later.",
    type: "string",
  },
];
