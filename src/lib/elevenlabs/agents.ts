...
const DATA_COLLECTION_FIELDS = [
  {
    ...
    description:
      ...
      "callback (the person gave a SPECIFIC time OR a timeframe to call them back — e.g. 'call me tomorrow at 3', 'try me next week', 'call back this afternoon'. This is a POSITIVE signal: they're open to talking, just not right now. Whenever you use this, also fill callback_datetime. Do NOT use this if the goal was already accomplished on this call — that is goal_met); " +
